...
export const ASSIGNMENT_TRANSITIONS: Record<AssignmentStatus, AssignmentStatus[]> = {
  ASSIGNED: [AssignmentStatus.ACCEPTED, AssignmentStatus.DECLINED, AssignmentStatus.REASSIGNED, AssignmentStatus.CANCELLED],
  ACCEPTED: [AssignmentStatus.COMPLETED, AssignmentStatus.REASSIGNED, AssignmentStatus.CANCELLED],
  DECLINED: [],
  REASSIGNED: [],
  CANCELLED: [],
  COMPLETED: [],
