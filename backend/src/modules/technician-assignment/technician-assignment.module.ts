...
@Module({
  ...
  providers: [TechnicianAssignmentService, AssignmentEngineService, WorkloadService, TechnicianAvailabilityService],
  exports: [TechnicianAssignmentService, AssignmentEngineService, WorkloadService],
})
