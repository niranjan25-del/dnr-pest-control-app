...
export class BookingsController {
  ...
  create(@CurrentUser() actor: AuthenticatedUser, @Body() dto: CreateBookingDto) {
    return this.bookings.create(actor, dto);
  }

  @Get()
  list(@CurrentUser() actor: AuthenticatedUser, @Query() filter: BookingFilterDto) {
  ...
  history(@CurrentUser() actor: AuthenticatedUser, @Query() filter: BookingFilterDto) {
    return this.bookings.customerHistory(actor, filter);
  }

  @Get('technician/schedule')
  @Roles(UserRole.TECHNICIAN)
  schedule(@CurrentUser() actor: AuthenticatedUser, @Query() filter: BookingFilterDto) {
