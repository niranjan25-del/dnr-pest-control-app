...
export enum Granularity { DAILY = 'DAILY', WEEKLY = 'WEEKLY', MONTHLY = 'MONTHLY', ANNUAL = 'ANNUAL' }

export const GRANULARITY_UNIT: Record<Granularity, string> = {
  DAILY: 'day', WEEKLY: 'week', MONTHLY: 'month', ANNUAL: 'year',
};

export enum ReportType { REVENUE = 'REVENUE', BOOKINGS = 'BOOKINGS', CUSTOMERS = 'CUSTOMERS', TECHNICIANS = 'TECHNICIANS', SUBSCRIPTIONS = 'SUBSCRIPTIONS' }
