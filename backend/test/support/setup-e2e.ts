...
import { stripeModuleMock, createFirebaseAdminMock, createS3Mock, presignMock } from './mocks/external';
...
jest.mock('@aws-sdk/client-s3', () => ({
  ...
  DeleteObjectCommand: jest.fn((a) => ({ __type: 'DeleteObjectCommand', ...a })),
}));
jest.mock('@aws-sdk/s3-request-presigner', () => ({ getSignedUrl: presignMock }));
